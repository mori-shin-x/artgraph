...
- [ ] T004a [P] Create `templates/skills/_shared/package-manager.md` (**English**) — package manager detection logic (npm / pnpm / Bun / Deno from lockfile or `package.json#packageManager`; **Yarn intentionally excluded** — `yarn.lock` triggers npm fallback + user warning), install/exec command mapping table, bash detection snippet for `artgraph-setup` Skill to use (FR-026, R14)
